...
$string['cria_api_key'] = 'Clé API Cria';
$string['cria_api_key_help'] = 'Clé API maître utilisée pour l\'authentification à Criabot/Criadex. Si local_cria est installé, sa clé API sera privilégiée automatiquement.';
...
$string['criabot_url'] = 'URL Criabot';
$string['criabot_url_help'] = 'URL de base de Criabot (ex. http://criabot:25575). Si définie, elle sera utilisée à la place de l\'ancienne URL Cria.';
$string['criadex_embed_id'] = 'ID d\'intégration Criadex';
$string['criadex_embed_id_help'] = 'Entrez l\'ID d\'intégration criadex pour votre serveur Cria. Vous devrez peut-être demander à votre administrateur système. Utilisé uniquement en secours si la recherche des valeurs par défaut en direct depuis Criabot échoue.';
$string['criadex_model_id'] = 'ID de modèle Criadex';
$string['criadex_model_id_help'] = 'Entrez l\'ID de modèle criadex pour votre serveur Cria. Vous devrez peut-être demander à votre administrateur système. Utilisé uniquement en secours si la recherche des valeurs par défaut en direct depuis Criabot échoue.';
$string['criadex_rerank_id'] = 'ID de reclassement Criadex';
$string['criadex_rerank_id_help'] = 'Entrez l\'ID de reclassement criadex pour votre serveur Cria. Vous devrez peut-être demander à votre administrateur système. Utilisé uniquement en secours si la recherche des valeurs par défaut en direct depuis Criabot échoue.';
...
$string['gradebook_baseline_detected'] = 'Le carnet de notes existant sera utilisé comme référence.';
$string['gradebook_baseline_not_found'] = 'Aucune configuration de référence n\'a été trouvée.';
$string['gradebook_syllabus_found'] = 'Plan de cours trouvé. Démarrage à partir de l\'analyse du syllabus/contexte.';
$string['gradebook_syllabus_needed'] = 'Si vous avez un plan de cours, téléversez-le via le bloc Assistant IA (ou ajoutez-le comme fichier dans le cours), puis choisissez Continuer. Si le fichier est déjà dans le cours mais reste inutilisable, téléversez une copie lisible en texte ou ajoutez plus de contenu du plan de cours, puis choisissez Continuer de nouveau.';
$string['gradebook_baseline_prompt_title'] = 'Référence détectée';
$string['gradebook_baseline_prompt_message'] = 'Une configuration existante du carnet de notes a été trouvée. Voulez-vous l\'utiliser comme référence ?';
$string['gradebook_baseline_prompt_yes'] = 'Utiliser la référence';
$string['gradebook_baseline_prompt_no'] = 'Démarrer à neuf';
$string['gradebook_baseline_prompt_yes_tooltip'] = 'Utiliser la structure actuelle du carnet de notes du cours comme référence.';
$string['gradebook_baseline_prompt_no_tooltip'] = 'Ignorer l\'import de référence et régénérer à partir du syllabus/contexte.';
...
$string['gradebook_revert_session'] = 'Revenir à la configuration d\'origine';
$string['gradebook_revert_session_confirm'] = 'Revenir à la configuration initiale du carnet de notes capturée avant l\'application IA ? Cette action supprime l\'arborescence Assistante IA et restaure le placement original des éléments et catégories.';
$string['gradebook_revert_session_tooltip'] = 'Restaure la configuration des notes du cours à partir du snapshot de référence pré-application.';
$string['gradebook_revert_completed'] = 'La configuration des notes a été restaurée à la référence d\'origine.';
$string['gradebook_revert_failed'] = 'Impossible de restaurer la configuration d\'origine du carnet de notes.';
...
$string['gradebook_delete_baseline_warning'] = 'Attention : Cette session a été démarrée à partir d\'une référence existante du carnet de notes et a été modifiée. Sa suppression détruira définitivement vos modifications actuelles ET la sauvegarde originale de votre carnet de notes. Vous ne pourrez PLUS revenir en arrière par la suite. Nous vous recommandons d\'utiliser l\'option "Revenir à la configuration d\'origine" à la place si vous souhaitez récupérer votre ancien carnet de notes.';
$string['gradebook_delete_baseline_confirm'] = 'Je comprends, tout supprimer';
...
$string['gradebook_subcategory_none'] = '— Aucune (catégorie parente) —';
$string['gradebook_subcategory_label'] = 'Sous-catégorie pour {$a}';
$string['gradebook_subcategory_select_title'] = 'Facultatif : choisissez une sous-catégorie, ou laissez Aucune pour rester dans la catégorie parente.';
...
$string['gradebook_mapping_empty_category'] = 'Ces catégories n’ont aucune activité assignée : {$a}. Choisissez une ligne d’activité, supprimez la catégorie ou ajoutez un élément de note manuel à lui attribuer.';
$string['gradebook_add_manual_item'] = 'Ajouter un élément de note manuel';
$string['gradebook_manual_item_label'] = 'Élément de note manuel';
$string['gradebook_add_manual_item_prompt'] = 'Nom de l’élément de note manuel dans {$a}';
$string['gradebook_add_manual_item_default_name'] = 'Élément manuel {$a}';
$string['gradebook_add_manual_item_failed'] = 'Impossible de créer l’élément de note manuel. Réessayez.';
$string['gradebook_add_manual_item_created'] = 'Élément de note manuel « {$a} » ajouté.';
$string['gradebook_missing_items_assessment'] = 'Évaluation';
$string['gradebook_missing_items_action'] = 'Action';
$string['gradebook_missing_items_activity'] = 'Activité';
$string['gradebook_missing_items_grade_item'] = 'Élément de note';
$string['gradebook_missing_items_skip'] = 'Ignorer (non inclus)';
$string['gradebook_missing_items_submit'] = 'Soumettre';
$string['gradebook_missing_items_partial_failed'] = 'Certains éléments ont été créés, mais ceux-ci ont échoué. Réglez les lignes restantes et soumettez à nouveau :';
$string['gradebook_missing_items_suggested_suffix'] = ' (suggéré)';
$string['gradebook_missing_items_type'] = 'Type';
$string['gradebook_missing_items_group_mode'] = 'Mode de groupe';
$string['gradebook_demo_category'] = 'Catégorie';
$string['gradebook_demo_weight'] = 'Pondération';
$string['gradebook_demo_score'] = 'Note';
$string['gradebook_demo_apply'] = 'Appliquer';
$string['gradebook_demo_reset'] = 'Réinitialiser';
$string['gradebook_demo_total_weight'] = 'Pondération totale';
...
$string['error'] = 'Erreur';
$string['embed_loader_unavailable'] = 'L\'Assistant IA est temporairement indisponible.';
$string['embed_loader_unavailable_help'] = 'Le lanceur de l\'assistant est masqué car le service d\'intégration n\'a pas retourné un script de chargement valide. Vérifiez l\'URL/le port de l\'API Embed et l\'état du service.';
