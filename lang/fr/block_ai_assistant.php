...
$string['gradebook_download_result'] = 'Télécharger JSON';
$string['gradebook_download_word'] = 'Télécharger Word';
$string['gradebook_download_pdf'] = 'Télécharger le PDF';
$string['gradebook_copy_summary'] = 'Copier le résumé';
$string['gradebook_copied'] = 'Résumé copié dans le presse-papiers.';
