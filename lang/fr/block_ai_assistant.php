...
$string['gradebook_delete_session_confirm'] = 'Supprimer cette session du carnet de notes et en démarrer une nouvelle ? Cette action est irréversible.';
$string['gradebook_delete_session_tooltip'] = 'La suppression retire définitivement la session actuelle du carnet de notes, puis démarre une nouvelle session.';
