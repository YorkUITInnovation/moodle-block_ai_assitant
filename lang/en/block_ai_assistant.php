...
$string['criadex_embed_id'] = 'Criadex Enbed ID';
...
$string['system_message'] = 'This is a system test message';
$string['no_context_message'] = 'This is a test no context message';
