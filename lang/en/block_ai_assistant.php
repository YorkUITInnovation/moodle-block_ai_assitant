...
$string['gradebook_delete_session_confirm'] = 'Delete this gradebook session and start a new one? This cannot be undone.';
$string['gradebook_delete_session_tooltip'] = 'Delete permanently removes the current gradebook session, then starts a brand new one.';
