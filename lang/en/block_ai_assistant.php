...
$string['gradebook_syllabus_needed'] = 'Please upload your course syllabus via the AI Assistant block (or add a syllabus file in the course), then choose Continue.';
