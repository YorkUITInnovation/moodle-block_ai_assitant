...
$string['cria_api_key_help'] = 'Master API key used to authenticate to Criabot/Criadex. If local_cria is installed, its API key will be preferred automatically.';
...
$string['criadex_embed_id_help'] = 'Enter the criadex embed id to your Cria server. You might have to ask your system administrator. Only used as a fallback if the live default lookup from Criabot fails.';
$string['criadex_model_id'] = 'Criadex Model ID';
$string['criadex_model_id_help'] = 'Enter the criadex model id to your Cria server. You might have to ask your system administrator. Only used as a fallback if the live default lookup from Criabot fails.';
$string['criadex_rerank_id'] = 'Criadex Rerank ID';
$string['criadex_rerank_id_help'] = 'Enter the criadex rerank id to your Cria server. You might have to ask your system administrator. Only used as a fallback if the live default lookup from Criabot fails.';
...
$string['gradebook_baseline_detected'] = 'Using your existing gradebook as the baseline.';
$string['gradebook_baseline_not_found'] = 'No existing gradebook baseline found.';
$string['gradebook_syllabus_found'] = 'Found course syllabus. Starting from syllabus/context analysis.';
$string['gradebook_syllabus_needed'] = 'If you have a course syllabus, upload it via the AI Assistant block (or add it as a file in the course), then choose Continue. If the file is already in the course but it still cannot be used, upload a text-readable copy or add more syllabus text, then choose Continue again.';
...
$string['gradebook_baseline_prompt_yes_tooltip'] = 'Use your existing course gradebook structure as the baseline.';
$string['gradebook_baseline_prompt_no_tooltip'] = 'Discard baseline import and regenerate from syllabus context.';
...
$string['gradebook_missing_items_assessment'] = 'Assessment';
$string['gradebook_missing_items_action'] = 'Action';
$string['gradebook_missing_items_activity'] = 'Activity';
$string['gradebook_missing_items_grade_item'] = 'Grade item';
$string['gradebook_missing_items_skip'] = 'Skip (not included)';
$string['gradebook_missing_items_submit'] = 'Submit';
$string['gradebook_missing_items_partial_failed'] = 'Created some items, but these failed. Resolve the remaining rows and submit again:';
$string['gradebook_missing_items_suggested_suffix'] = ' (suggested)';
$string['gradebook_missing_items_type'] = 'Type';
$string['gradebook_missing_items_group_mode'] = 'Group mode';
$string['gradebook_demo_category'] = 'Category';
$string['gradebook_demo_weight'] = 'Weight';
$string['gradebook_demo_score'] = 'Score';
$string['gradebook_demo_apply'] = 'Apply';
$string['gradebook_demo_reset'] = 'Reset';
$string['gradebook_demo_total_weight'] = 'Total weight';
