...
require_once("$CFG->dirroot/blocks/ai_assistant/classes/tables/tutorials_table.php");
...
if (!$table->is_downloading()) {
    ...
    $table->define_columns(['name', 'description', 'enabled']);
    $table->define_headers(['Name', 'Description', 'Enabled']);
    $PAGE->set_context($context);
    $PAGE->set_url(new moodle_url('/blocks/ai_assistant/tutorials.php', ['courseid' => $courseid]));
    $PAGE->set_title(get_string('Tutorials', 'block_ai_assistant'));
    $PAGE->set_heading(get_string('Tutorials', 'block_ai_assistant'));
}
