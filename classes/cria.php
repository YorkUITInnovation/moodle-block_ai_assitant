...
class cria
{
    ...
    private static function get_create_cria_bot_config($course_id, $is_syllabus = true)
    {
        ...
        $data = array(
            ...
            'no_context_use_message' => isset($config->no_context_use_message) ? (int)$config->no_context_use_message : 1,
            'no_context_llm_guess' => isset($config->no_context_llm_guess) ? (int)$config->no_context_llm_guess : 0,
